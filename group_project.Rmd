...
From analyzing the data and variables we have, we have decided to move forward with finding out which combination of habits would lead to being obese. Several summary statistics and data visualizations lead us to believe that factors such as ___ have a significant __
