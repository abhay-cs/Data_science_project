...
```
As you can see, the probability that an individual is older than 40 if their BMI is >35 is around 1% which is very low likelylihood. this suggests some form of missing data which we believe is not random as our results show that the higher in age, the lower the instances of very high BMI. In fact the maximum BMI observed decreases inversly with age. we exrapolate this data by assuming that this is caused due to health complications that we will attribute to obesity, and we will uses this as the basis for our health scoring system
